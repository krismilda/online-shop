package Shop.repositoryUserFileImplementation;
...
public class UserRepositoryFileImplementation implements IUserRepository
{
	...
	List<User> users=new ArrayList<User>();
		 FileInputStream fileIn = new FileInputStream("C:\\Users\\Milda\\eclipse-workspace2\\configurations\\users.bin");
	...
	FileOutputStream fos = new FileOutputStream("C:\\Users\\Milda\\eclipse-workspace2\\configurations\\users.bin");
