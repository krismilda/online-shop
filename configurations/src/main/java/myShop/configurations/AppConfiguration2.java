...
import Shop.christmasDiscount_Implementation.ChristmasDiscount;
...
import Shop.facebookUserFactory.FacebookUserFactory;
...
public class AppConfiguration2 {
    ...
    public IProductFactory iProductFactory() {
        return new ChinaProductFactory();
    }
    ...
    public IOrderService iOrderService(IBankService bankService, IOrderServiceAPI orderServiceAPI,
    		...
    		@Qualifier ("EstonianDeliveryService") IDeliveryServiceAPI deliveryService) {
